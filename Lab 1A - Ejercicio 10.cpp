// Laboratorio 1A - Ejercicio #10 / Jose Pablo Agüero Mora (2021126372)
...
void main() // Función main, inicia y termina dentro de las llaves, el programa inicia su ejecución en esta función
{
	...
	alumno Alumno100[1000]; // Se genera un arreglo a partir de una estructura previamente definida
	Alumno100[1].activo = 1; // Se cambia el valor de activo dentro de la estructura en el primer elemento del arreglo
	Alumno100[1].carnet = 201563645; // Se cambia el valor de carnet dentro de la estructura en el primer elemento del arreglo
	strcpy_s(Alumno100[1].carrera, carreraq); // Se copia la cadena 2 en la cadena 1 (en el primer elemento del arreglo)/ Este tipo de copia strcpy_s evita el buffer overflow
	strcpy_s(Alumno100[1].nombre, Nombreq); // Se copia la cadena 2 en la cadena 1 (en el primer elemento del arreglo)/ Este tipo de copia strcpy_s evita el buffer overflow
	cout << "El alumno " << Alumno100[1].nombre << " fue resgistrado con el numero de carnet " << Alumno100[1].carnet << endl; // Se muestra un mensaje en pantalla
	cout << "en la carrera " << Alumno100[1].carrera << "." << endl; // Se muestra un mensaje en pantalla
...
/* Para este programa se crea una estructura con 4 tipos de dato, además se genera un arreglo y se modifica solo el primer elemento del arreglo, dos 
de estos datos se modifican en la función main haciendo referencia a la estructura y los otros usan la instrucción strcpy_s para copiar su valor de variables 
previamente consrtuida */